...
class CommandEngine(val context: GeneralContext) {
    ...
    init {
        ...
        handlers.forEach {handlerClass ->
            ...
            val handler = handlerClass.getConstructor(GeneralContext::class.java).newInstance(context) as CommandHandler<out Command>
