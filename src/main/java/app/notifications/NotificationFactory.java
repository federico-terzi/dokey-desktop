...
public class NotificationFactory {
    ...
    public static void showNotification(String title, String message) {
        ...
        try {
            ...
            if (OSValidator.isMac()) {  // If on MAC OS, make the notification appear from the top.
                targetY = screen.getMinY() + notificationStage.getHeight() - 30;
                initialY = screen.getMinY() - notificationStage.getHeight();
            }
