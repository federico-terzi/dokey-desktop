...
public class SettingsStage extends Stage {
    ...
    public SettingsStage(ApplicationManager applicationManager, ResourceBundle resourceBundle,
                         SettingsManager settingsManager, StartupManager startupManager,
                         StorageManager storageManager, OnSettingsCloseListener onSettingsCloseListener) throws IOException {
